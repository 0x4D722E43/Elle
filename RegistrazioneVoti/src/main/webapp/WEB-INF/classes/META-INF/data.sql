...
INSERT INTO `registrazionevotidb`.`PROFESSORI` (`ORE_RICEVIMENTO`, `POSIZIONE_UFFICIO`, `ID`, `FACOLTA`) VALUES ('14 - 16 Martedi', 'Piano C', '1', '1');
...
INSERT INTO `registrazionevotidb`.`PROFESSORI` (`ORE_RICEVIMENTO`, `POSIZIONE_UFFICIO`, `ID`, `FACOLTA`) VALUES ('9 - 11 Mercoledi', 'Piano C', '2', '1');
...
INSERT INTO `registrazionevotidb`.`PROFESSORI` (`ORE_RICEVIMENTO`, `ID`, `FACOLTA`) VALUES ('16 - 18 Venerdi', '4', '2');
...
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('1', FALSE, '1', '5');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('2', FALSE, '1', '6');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('3', FALSE, '1', '7');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('4', FALSE, '1', '8');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('5', FALSE, '1', '9');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('6', FALSE, '1', '10');

INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('7', FALSE, '1', '11');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('8', FALSE, '1', '12');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('9', FALSE, '1', '13');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('10', FALSE, '1', '14');
INSERT INTO `registrazionevotidb`.`ISCRIZIONI_CORSI` (`ID`, `SUPERATO`, `CORSO`, `STUDENTE`) VALUES ('11', FALSE, '1', '15');
